...
sys_thrdresume(void)
{
  ...
  struct proc *p = myproc();
  if(is_exit == 0){
    p->trapframe->s0 = p->thrdstop_context[p->thrdstop_context_id].s_regs[0];
    p->trapframe->s1 = p->thrdstop_context[p->thrdstop_context_id].s_regs[1];
    p->trapframe->s2 = p->thrdstop_context[p->thrdstop_context_id].s_regs[2];
    p->trapframe->s3 = p->thrdstop_context[p->thrdstop_context_id].s_regs[3];
    p->trapframe->s4 = p->thrdstop_context[p->thrdstop_context_id].s_regs[4];
    p->trapframe->s5 = p->thrdstop_context[p->thrdstop_context_id].s_regs[5];
    p->trapframe->s6 = p->thrdstop_context[p->thrdstop_context_id].s_regs[6];
    p->trapframe->s7 = p->thrdstop_context[p->thrdstop_context_id].s_regs[7];
    p->trapframe->s8 = p->thrdstop_context[p->thrdstop_context_id].s_regs[8];
    p->trapframe->s9 = p->thrdstop_context[p->thrdstop_context_id].s_regs[9];
    p->trapframe->s10 = p->thrdstop_context[p->thrdstop_context_id].s_regs[10];
    p->trapframe->s11 = p->thrdstop_context[p->thrdstop_context_id].s_regs[11];
    p->trapframe->ra = p->thrdstop_context[p->thrdstop_context_id].ra;
    p->trapframe->sp = p->thrdstop_context[p->thrdstop_context_id].sp;
    p->trapframe->t0 = p->thrdstop_context[p->thrdstop_context_id].t_regs[0];
    p->trapframe->t1 = p->thrdstop_context[p->thrdstop_context_id].t_regs[1];
    p->trapframe->t2 = p->thrdstop_context[p->thrdstop_context_id].t_regs[2];
    p->trapframe->t3 = p->thrdstop_context[p->thrdstop_context_id].t_regs[3];
    p->trapframe->t4 = p->thrdstop_context[p->thrdstop_context_id].t_regs[4];
    p->trapframe->t5 = p->thrdstop_context[p->thrdstop_context_id].t_regs[5];
    p->trapframe->t6 = p->thrdstop_context[p->thrdstop_context_id].t_regs[6];
    p->trapframe->a0 = p->thrdstop_context[p->thrdstop_context_id].a_regs[0];
    p->trapframe->a1 = p->thrdstop_context[p->thrdstop_context_id].a_regs[1];
    p->trapframe->a2 = p->thrdstop_context[p->thrdstop_context_id].a_regs[2];
    p->trapframe->a3 = p->thrdstop_context[p->thrdstop_context_id].a_regs[3];
    p->trapframe->a4 = p->thrdstop_context[p->thrdstop_context_id].a_regs[4];
    p->trapframe->a5 = p->thrdstop_context[p->thrdstop_context_id].a_regs[5];
    p->trapframe->a6 = p->thrdstop_context[p->thrdstop_context_id].a_regs[6];
    p->trapframe->a7 = p->thrdstop_context[p->thrdstop_context_id].a_regs[7];
    p->trapframe->gp = p->thrdstop_context[p->thrdstop_context_id].gp;
    p->trapframe->tp = p->thrdstop_context[p->thrdstop_context_id].tp;
    p->trapframe->epc = p->thrdstop_context[p->thrdstop_context_id].epc;
  }
  if(is_exit == 1){
