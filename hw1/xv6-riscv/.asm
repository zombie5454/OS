...
void f3(void *arg)
{
   ...
   c:	1800                	addi	s0,sp,48
    ...
    while (1) {
        printf("thread 3: %d\n", i++);
   e:	6489                	lui	s1,0x2
  10:	71048593          	addi	a1,s1,1808 # 2710 <__global_pointer$+0x131f>
  14:	00001517          	auipc	a0,0x1
  18:	b8450513          	addi	a0,a0,-1148 # b98 <thread_start_threading+0x2c>
  1c:	00000097          	auipc	ra,0x0
  20:	756080e7          	jalr	1878(ra) # 772 <printf>
  24:	71148493          	addi	s1,s1,1809
  28:	00001997          	auipc	s3,0x1
  2c:	b7098993          	addi	s3,s3,-1168 # b98 <thread_start_threading+0x2c>
        if(i == 10005){
  30:	6909                	lui	s2,0x2
  32:	71590913          	addi	s2,s2,1813 # 2715 <__global_pointer$+0x1324>
            return;
            //thread_exit();
        }
        thread_yield();
  36:	00001097          	auipc	ra,0x1
  3a:	afe080e7          	jalr	-1282(ra) # b34 <thread_yield>
        printf("thread 3: %d\n", i++);
  3e:	85a6                	mv	a1,s1
...
void f2(void *arg)
{
  ...
  74:	b3850513          	addi	a0,a0,-1224 # ba8 <thread_start_threading+0x3c>
  78:	00000097          	auipc	ra,0x0
  7c:	6fa080e7          	jalr	1786(ra) # 772 <printf>
  80:	4485                	li	s1,1
  82:	00001a17          	auipc	s4,0x1
  86:	b26a0a13          	addi	s4,s4,-1242 # ba8 <thread_start_threading+0x3c>
        if (i == 10) {
  8a:	49a9                	li	s3,10
  ...
  94:	aa4080e7          	jalr	-1372(ra) # b34 <thread_yield>
        printf("thread 2: %d\n",i++);
...
void f1(void *arg)
{
 ...
 102:	aba50513          	addi	a0,a0,-1350 # bb8 <thread_start_threading+0x4c>
 106:	00000097          	auipc	ra,0x0
 10a:	66c080e7          	jalr	1644(ra) # 772 <printf>
 10e:	06500493          	li	s1,101
 112:	00001a17          	auipc	s4,0x1
 116:	aa6a0a13          	addi	s4,s4,-1370 # bb8 <thread_start_threading+0x4c>
        if (i == 110) {
 ...
 126:	a12080e7          	jalr	-1518(ra) # b34 <thread_yield>
        printf("thread 1: %d\n", i++);
...
int main(int argc, char **argv)
{
 ...
 16e:	a02080e7          	jalr	-1534(ra) # b6c <thread_start_threading>
    printf("\nexited\n");
 172:	00001517          	auipc	a0,0x1
 176:	a5650513          	addi	a0,a0,-1450 # bc8 <thread_start_threading+0x5c>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4e2:	70250513          	addi	a0,a0,1794 # be0 <digits>
 4e6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5ae:	636b8b93          	addi	s7,s7,1590 # be0 <digits>
 ...
 6ee:	4ee90913          	addi	s2,s2,1262 # bd8 <thread_start_threading+0x6c>
        while(*s != 0){
...
free(void *ap)
{
 ...
 7b6:	4467b783          	ld	a5,1094(a5) # bf8 <freep>
 ...
 7e4:	00e6ea63          	bltu	a3,a4,7f8 <free+0x50>
{
 ...
 826:	3cf73b23          	sd	a5,982(a4) # bf8 <freep>
}
 82a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 858:	3a453503          	ld	a0,932(a0) # bf8 <freep>
 ...
 880:	37c90913          	addi	s2,s2,892 # bf8 <freep>
  if(p == (char*)-1)
 884:	5afd                	li	s5,-1
 886:	a88d                	j	8f8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 888:	00000797          	auipc	a5,0x0
 88c:	38078793          	addi	a5,a5,896 # c08 <base>
 890:	00000717          	auipc	a4,0x0
 894:	36f73423          	sd	a5,872(a4) # bf8 <freep>
 898:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8ba:	34a73123          	sd	a0,834(a4) # bf8 <freep>
      return (void*)(p + 1);
...
struct thread *thread_create(void (*f)(void *), void *arg){
 ...
 9c4:	23470713          	addi	a4,a4,564 # bf4 <id>
 9c8:	431c                	lw	a5,0(a4)
...
void thread_add_runqueue(struct thread *t){
 ...
 9f8:	20c7b783          	ld	a5,524(a5) # c00 <current_thread>
 ...
 a12:	1ea7b923          	sd	a0,498(a5) # c00 <current_thread>
        current_thread->previous = t;
...
void schedule(void){
 ...
 a26:	1de78793          	addi	a5,a5,478 # c00 <current_thread>
 a2a:	6398                	ld	a4,0(a5)
...
void thread_exit(void){
 ...
 a44:	1c04b483          	ld	s1,448(s1) # c00 <current_thread>
 a48:	70dc                	ld	a5,160(s1)
 a4a:	02f48d63          	beq	s1,a5,a84 <thread_exit+0x4e>
        // TODO
        current_thread->next->previous = current_thread->previous;
 a4e:	6cd8                	ld	a4,152(s1)
 a50:	efd8                	sd	a4,152(a5)
        current_thread->previous->next = current_thread->next;
 a52:	70dc                	ld	a5,160(s1)
 a54:	f35c                	sd	a5,160(a4)
        
        struct thread *useless = current_thread;
        current_thread = current_thread->next;
 a56:	00000717          	auipc	a4,0x0
 a5a:	1af73523          	sd	a5,426(a4) # c00 <current_thread>
        free(useless->stack);
 a5e:	6888                	ld	a0,16(s1)
 a60:	00000097          	auipc	ra,0x0
 a64:	d48080e7          	jalr	-696(ra) # 7a8 <free>
        free(useless);
 a68:	8526                	mv	a0,s1
 a6a:	00000097          	auipc	ra,0x0
 a6e:	d3e080e7          	jalr	-706(ra) # 7a8 <free>
        dispatch();
 a72:	00000097          	auipc	ra,0x0
 a76:	040080e7          	jalr	64(ra) # ab2 <dispatch>
 ...
 a7e:	64a2                	ld	s1,8(sp)
 a80:	6105                	addi	sp,sp,32
 a82:	8082                	ret
        free(current_thread->stack);
 a84:	6888                	ld	a0,16(s1)
 a86:	00000097          	auipc	ra,0x0
 a8a:	d22080e7          	jalr	-734(ra) # 7a8 <free>
        free(current_thread);
 a8e:	00000517          	auipc	a0,0x0
 a92:	17253503          	ld	a0,370(a0) # c00 <current_thread>
 a96:	00000097          	auipc	ra,0x0
 a9a:	d12080e7          	jalr	-750(ra) # 7a8 <free>
        longjmp(env_st, 1);
 a9e:	4585                	li	a1,1
 aa0:	00000517          	auipc	a0,0x0
 aa4:	17850513          	addi	a0,a0,376 # c18 <env_st>
 aa8:	00000097          	auipc	ra,0x0
 aac:	ea4080e7          	jalr	-348(ra) # 94c <longjmp>
}
 ab0:	b7e9                	j	a7a <thread_exit+0x44>

0000000000000ab2 <dispatch>:
void dispatch(void){
 ...
 abe:	14653503          	ld	a0,326(a0) # c00 <current_thread>
 ac2:	09452783          	lw	a5,148(a0)
 ac6:	efb9                	bnez	a5,b24 <dispatch+0x72>
        current_thread->buf_set = 1;
 ac8:	4785                	li	a5,1
 aca:	08f52a23          	sw	a5,148(a0)
        if(setjmp(env_tmp) == 0){
 ace:	00000517          	auipc	a0,0x0
 ad2:	1ba50513          	addi	a0,a0,442 # c88 <env_tmp>
 ad6:	00000097          	auipc	ra,0x0
 ada:	e3e080e7          	jalr	-450(ra) # 914 <setjmp>
 ade:	c105                	beqz	a0,afe <dispatch+0x4c>
        current_thread->fp(current_thread->arg);
 ae0:	00000797          	auipc	a5,0x0
 ae4:	1207b783          	ld	a5,288(a5) # c00 <current_thread>
 ae8:	6398                	ld	a4,0(a5)
 aea:	6788                	ld	a0,8(a5)
 aec:	9702                	jalr	a4
        thread_exit();
 aee:	00000097          	auipc	ra,0x0
 af2:	f48080e7          	jalr	-184(ra) # a36 <thread_exit>
}
 af6:	60a2                	ld	ra,8(sp)
 af8:	6402                	ld	s0,0(sp)
 ...
 b02:	1027b783          	ld	a5,258(a5) # c00 <current_thread>
 b06:	6f9c                	ld	a5,24(a5)
 b08:	00000717          	auipc	a4,0x0
 b0c:	1ef73423          	sd	a5,488(a4) # cf0 <env_tmp+0x68>
            longjmp(env_tmp, 1);
 b10:	4585                	li	a1,1
 b12:	00000517          	auipc	a0,0x0
 b16:	17650513          	addi	a0,a0,374 # c88 <env_tmp>
 b1a:	00000097          	auipc	ra,0x0
 b1e:	e32080e7          	jalr	-462(ra) # 94c <longjmp>
 b22:	bf7d                	j	ae0 <dispatch+0x2e>
        longjmp(current_thread->env, 1);
 b24:	4585                	li	a1,1
 b26:	02050513          	addi	a0,a0,32
 b2a:	00000097          	auipc	ra,0x0
 b2e:	e22080e7          	jalr	-478(ra) # 94c <longjmp>
}
 b32:	b7d1                	j	af6 <dispatch+0x44>

0000000000000b34 <thread_yield>:
void thread_yield(void){
 ...
 b40:	0c453503          	ld	a0,196(a0) # c00 <current_thread>
 b44:	02050513          	addi	a0,a0,32
 b48:	00000097          	auipc	ra,0x0
 b4c:	dcc080e7          	jalr	-564(ra) # 914 <setjmp>
 b50:	c509                	beqz	a0,b5a <thread_yield+0x26>
}
 b52:	60a2                	ld	ra,8(sp)
 b54:	6402                	ld	s0,0(sp)
 ...
 b5e:	ec2080e7          	jalr	-318(ra) # a1c <schedule>
        dispatch();
 b62:	00000097          	auipc	ra,0x0
 b66:	f50080e7          	jalr	-176(ra) # ab2 <dispatch>
}
 b6a:	b7e5                	j	b52 <thread_yield+0x1e>

0000000000000b6c <thread_start_threading>:
void thread_start_threading(void){
 ...
 b78:	0a450513          	addi	a0,a0,164 # c18 <env_st>
 b7c:	00000097          	auipc	ra,0x0
 b80:	d98080e7          	jalr	-616(ra) # 914 <setjmp>
 b84:	c509                	beqz	a0,b8e <thread_start_threading+0x22>
        dispatch();
}
 b86:	60a2                	ld	ra,8(sp)
 b88:	6402                	ld	s0,0(sp)
 ...
 b92:	f24080e7          	jalr	-220(ra) # ab2 <dispatch>
}
 b96:	bfc5                	j	b86 <thread_start_threading+0x1a>
